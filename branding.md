...
| Images        | Are           | Cool  |
| ------------- | ------------- | ----- |
| ![Howl's Moving Castle](/assets/branding/howls-moving-caslte.jpg "Logo Title Text 1") | ![Castle in the Sky](/assets/branding/castle-in-the-sky.jpg "Logo Title Text 1") | ![Castle in the Sky](/assets/branding/robot.jpg "Logo Title Text 1") |
...
Whombies have no decernable language to you, but Bellow can talk to them. They are intelligent and a societal structure, but have no technology of their own. They rely on Bellows ability to use magic to power their civilization. They can't use the magic itself, but can use the tools that Bellow gives them.

They have at least two eyes. Are a solid color, but their shape can move. They also must have the Hexagon somewhere that is present in the Tinman Logo.
